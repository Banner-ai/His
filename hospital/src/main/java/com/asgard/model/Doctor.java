...
public class Doctor {
	...
	public String toString() {
		return "Doctor [id=" + id + ", name=" + name + ", certificate_type=" + certificate_type + ", ID_num=" + ID_num
				...
				+ education + ", noted=" + noted + ", time=" + time + ", secco_name=" + secco_name
				+ ", getSecco_name()=" + getSecco_name() + ", getId()=" + getId() + ", getName()=" + getName()
				+ ", getCertificate_type()=" + getCertificate_type() + ", getID_num()=" + getID_num() + ", getPhone()="
				+ getPhone() + ", getSpecial_plane()=" + getSpecial_plane() + ", getSex()=" + getSex() + ", getAge()="
				+ getAge() + ", getBirther()=" + getBirther() + ", getEmail()=" + getEmail() + ", getSection_id()="
				+ getSection_id() + ", getEducation()=" + getEducation() + ", getNoted()=" + getNoted() + ", getTime()="
				+ getTime() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
